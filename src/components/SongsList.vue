<template>
  <v-list flat class="px-6" >
    <v-list-item-group v-model="selectedItem"  class="pa-0" >
      <v-list-item v-for="(item, i) in visibleResults" :key="i" class="mb-1 pa-0 primary" style="height: 40px;">
        <p class ="my-3 mx-6" style="
          height: 16px; 
          width: 16px ;
          font-size: 12px;
          text-align: center;"
        ...
        <div class="myDiv pb-1" style=" height: 40px; width: 332px ;">
        ...
        <div class="myDiv py-3" style=" 
          ...
          >
          <v-list-item-content class="py-0">
            <v-list-item-subtitle style="font-size: 12px; text-align: center;"
